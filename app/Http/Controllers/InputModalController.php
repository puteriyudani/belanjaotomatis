...
class InputModalController extends Controller
{
    public function index()
    {
        ...
        return view('penilaian.inputmodal', compact('produks', 'kriterias'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            // Ambil nilai modal dari request
            ...
            return redirect()->route('rangking.modal', ['modal' => $modal])->with('msg', 'Berhasil disimpan');
        } catch (Exception $e) {
