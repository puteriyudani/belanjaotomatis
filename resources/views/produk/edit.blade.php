...
@section('content')
    <div class="d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 me-3">Edit Data Produk</h1>
    </div>
    @if ($errors->any())
    ...
    <form action="{{ route('produks.update', $produk->id) }}" method="POST">
        ...
        <div class="row g-3 mb-2 align-items-center">
            ...
            <div class="col-auto">
                <input type="text" name="nama" value="{{ $produk->nama }}" id="inputNama" class="form-control"
        ...
        <div class="row g-3 mb-2 align-items-center">
            ...
            <div class="col-auto">
                <input type="number" name="harga" value="{{ $produk->harga }}" id="inputHarga" class="form-control"
        ...
        <div class="row g-3 mb-2 align-items-center">
            ...
            <div class="col-auto">
                <input type="number" name="stock" value="{{ $produk->stock }}" id="inputStock" class="form-control"
        ...
        <div class="row g-3 mb-2 align-items-center">
            ...
            <div class="col-auto">
                <input type="number" name="sold" value="{{ $produk->sold }}" id="inputSold" class="form-control"
                    aria-describedby="SoldHelpInline">
            </div>
        </div>
